const products = [
	{
		...
		description:
			'The PlayStation 5s main features include a solid-state drive customized for high-speed data streaming, an AMD GPU capable of 4K resolution',
		brand: 'Sony',
	...
	},
	{
		...
		description:
			'The 2020 Apple MacBook Air has an amazing design, great keyboard, a best-in-class trackpad, and plenty else to love.',
		brand: 'Apple',
		category: 'Electronics',
		price: 1399.99,
		countInStock: 10,
	...
	},
	{
		...
		description:
			'The Razer Naga Trinity is a great, versatile gaming mouse thanks to its swappable side panel design.  Nevertheless, the Naga Trinity is very well-built and great for gamers',
		brand: 'Razer',
		category: 'Electronics',
		price: 111.99,
		countInStock: 10,
